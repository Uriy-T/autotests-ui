...
class ImageUploadWidgetComponent(BaseComponent):
    def __init__(self, page: Page, identifier: str):
        ...
        self.preview_image = Image(page,f'{identifier}-image-upload-widget-preview-image', 'Uploaded image')
        ...
        self.upload_input = FileInput(page,f'{identifier}-image-upload-widget-upload-button', 'Upload image')
