...
class CourseViewComponent(BaseComponent):
    def __init__(self, page: Page):
        ...
        self.score_max_text = Text(page,'course-max-score-info-row-view-text', 'Max score')
        self.score_min_text = Text(page,'course-min-score-info-row-view-text', 'Min score')
    ...
    def check_visible(self,
        ...
        self.title.check_have_text(label, nth=index)

        self.score_max_text.check_visible(nth=index)
        self.score_max_text.check_have_text(f'Max score: {max_score}', nth=index)

        self.score_min_text.check_visible(nth=index)
        self.score_min_text.check_have_text(f'Min score: {min_score}', nth=index)
